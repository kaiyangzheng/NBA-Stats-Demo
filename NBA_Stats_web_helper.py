stats_description={"PTS" : "The amount of points per game a player scores. Points can be acquired by scoring field goals (2 or 3 points) and free throws (1 point).",
                  ...
                  "3P%" : "The number of made two point shots over the number of three point shot attempts. Represents how efficient a player is at shooting three point field goals."
                  }
